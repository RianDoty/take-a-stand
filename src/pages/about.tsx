...
export default function About() {
  return (
    <>
      ...
      <p>
        I'm Rian Doty, the founder of Labor Unions For All.
      </p>
      <p>
        Now that COVID-19 is on the back foot and society can get back
        to not turning inside-out again, it seemed to me like the astronomical
        pricing of basic needs would, you know, chill. But seeing as that
      ...
      <p className="inverted">
        ...
        and getting a good, well-paying job that can support your needs,
